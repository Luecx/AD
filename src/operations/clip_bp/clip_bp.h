...
#ifndef CUDATEST1_SRC_OPERATIONS_CLIP_BP_CLIP_BP_H_
#define CUDATEST1_SRC_OPERATIONS_CLIP_BP_CLIP_BP_H_
...
// clang-format off
__global__ void clip_bp_kernel(
...
// clang-format off
template<Mode mode>
inline void clip_bp (const Tensor<float> &A,
                           Tensor<float> &A_grd,
...
#endif    // CUDATEST1_SRC_OPERATIONS_CLIP_BP_CLIP_BP_H_
