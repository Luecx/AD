...
#ifndef CUDATEST1_SRC_OPERATIONS__LOG_BP__LOG_BP_H_
#define CUDATEST1_SRC_OPERATIONS__LOG_BP__LOG_BP_H_
...
// clang-format off
template<Mode mode>
inline void log_bp   (const Tensor<float> &A,
                             Tensor<float> &A_grd,
...
// clang-format on
#endif    // CUDATEST1_SRC_OPERATIONS__LOG_BP__LOG_BP_H_
