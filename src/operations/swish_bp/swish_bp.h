...
#ifndef CUDATEST1_SRC_OPERATIONS__SWISH_BP__SWISH_BP_H_
#define CUDATEST1_SRC_OPERATIONS__SWISH_BP__SWISH_BP_H_
...
// clang-format off
template<Mode mode>
inline void swish_bp(const Tensor<float> &A,
                             Tensor<float> &A_grd,
...
#endif    // CUDATEST1_SRC_OPERATIONS__SWISH_BP__SWISH_BP_H_
