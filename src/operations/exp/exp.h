...
#ifndef CUDATEST1_SRC_OPERATIONS_EXP_EXP_H_
#define CUDATEST1_SRC_OPERATIONS_EXP_EXP_H_
...
// clang-format off
template<Mode mode>
inline void exp   (const Tensor<float> &A,
                          Tensor<float> &B){
    // clang-format on
...
// clang-format on
#endif    // CUDATEST1_SRC_OPERATIONS_EXP_EXP_H_
