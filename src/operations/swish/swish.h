...
#ifndef CUDATEST1_SRC_OPERATIONS_SWISH_SWISH_H_
#define CUDATEST1_SRC_OPERATIONS_SWISH_SWISH_H_
...
// clang-format off
template<Mode mode>
inline void swish   (const Tensor<float> &A,
                             Tensor<float> &B,
                             float scalar){
    // clang-format on
...
#endif    // CUDATEST1_SRC_OPERATIONS_SWISH_SWISH_H_
